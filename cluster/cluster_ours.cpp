...
main (int argc, char** argv)
{
  ...
  // for 1_pc
  vg.setLeafSize (10.0f, 30.0f, 30.0f);
  // for 2_pc
  ...
  while (cloud_filtered->points.size () > 0.3 * nr_points)
  {
    ...
    std::stringstream ss;
    ss << "/home/akshatha/pcl/cluster/cloud_plane_" << k << ".pcd";
  ...
  ec.setClusterTolerance (100); // 1cm
  ...
  for (std::vector<pcl::PointIndices>::const_iterator it = cluster_indices.begin (); it != cluster_indices.end (); ++it)
  {
    ...
    std::stringstream ss;
    ss << "/home/akshatha/pcl/cluster/cloud_cluster_" << j << ".pcd";
